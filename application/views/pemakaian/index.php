                        ...
                        <td style="text-align:center"> 
                            ...
                            <?php
                                    ...
                                    if( ($group_id==1)||($hak_akses['timbang_2']==1) ){                                        
                                        ...
                                        if($data->nama_muatan=="CANGKANG" && $data->jenis_transaksi=="Pakai"){
                                            echo '<a class="btn btn-circle btn-xs green" style="margin-bottom:4px" '
                                            . 'href="'.base_url('index.php/Pemakaian/pakai_cangkang_timbang_kedua/'.$data->id).'"> &nbsp; '
                                            . '<i class="fa fa-edit"></i> Timbang 2&nbsp; </a>'; 

                                        }else if($data->nama_muatan=="MERAH" && $data->jenis_transaksi=="Pakai"){
                                            echo '<a class="btn btn-circle btn-xs green" style="margin-bottom:4px" '
                                            . 'href="'.base_url('index.php/Pemakaian/pakai_merah_timbang_kedua/'.$data->id).'"> &nbsp; '
                                            . '<i class="fa fa-edit"></i> Timbang 2&nbsp; </a>'; 
...
function timbang_pertama(id){
    $.ajax({
        url: "<?php echo base_url('index.php/Pemakaian/get_data_otorisasi'); ?>",
        type: "POST",
        data : {id: id},
...
function simpandata(){
    ...
    if($.trim($("#berat_timbang_1").val()) == ""){
        ...
        $('#message').html("");
        $('.alert-danger').hide();
        $('#formku').attr("action", "<?php echo base_url(); ?>index.php/Pemakaian/save_timbang_pertama");
        $('#formku').submit();                    
    };
};
