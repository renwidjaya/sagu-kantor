...
<div class="row">                            
    <div class="col-md-12">   
        <?php
            if( ($group_id==1)||($hak_akses['pakai_merah_timbang_kedua']==1) ){
        ?>
        <div class="portlet box blue-hoki">
            <div class="portlet-title">
                <div class="caption">
                    <i class="fa fa-car"></i>PAKAI MERAH - Proses Timbang 2
                </div>                
            </div>
            <div class="portlet-body">
                <form class="eventInsForm" method="post" target="_self" name="formku" 
                    id="formku" action="<?php echo base_url('index.php/Pemakaian/save_pakai_merah_timbang_kedua'); ?>">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="row" style="text-align:right">
                            <div class="col-md-12">
                                ...
                                <a href="<?php echo base_url('index.php/Pemakaian/index/MERAH/Pakai'); ?>" class="btn btn-default">
                                    Kembali</a>
                            </div>
                        </div>
                    </div>
