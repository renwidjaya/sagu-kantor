        ...
        <div class="portlet box blue-hoki">
            ...
            <div class="portlet-body">
                <form class="eventInsForm" method="post" target="_self" name="formku" 
                    id="formku" action="<?php echo base_url('index.php/Pemakaian/save_pakai_cangkang_timbang_kedua'); ?>">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="row" style="text-align:right">
                            <div class="col-md-12">
                                ...
                                <a href="<?php echo base_url('index.php/Pemakaian/index/CANGKANG/Pakai'); ?>" class="btn btn-default">
                                    Kembali</a>
                            </div>
                        </div>
                    </div>
