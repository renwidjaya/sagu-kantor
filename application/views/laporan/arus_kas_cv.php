...
<div class="row">                            
    <div class="col-md-12"> 
        ...
        <?php
            if( ($group_id==1)||($hak_akses['arus_kas_cv']==1) ){
        ?>
        <div class="row">
            <div class="col-md-12">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="row" style="margin-bottom:5px">
                    <div class="col-md-6">
                        <?php
                            if( ($group_id==1)||($hak_akses['print_arus_kas_cv']==1) ){
                                echo '<a href="'.base_url().'index.php/Laporan/print_arus_kas_cv" class="btn green">
        ...
        <div class="portlet box blue-hoki">
            <div class="portlet-title">
                <div class="caption">
                    <i class="fa fa-file-o"></i>Laporan Arus Kas - Pembelian/ CV
                </div>
            </div>
...
function editKas(){  
    ...
    $("#myModal").find('.modal-title').text('Adjustment Kas - Pembelian/ CV');
...
function simpandata(){    
    if($.trim($("#tanggal").val()) == ""){
        ...
        $('#message').html("");
        $('.alert-danger').hide();
        $('#formku').attr("action", "<?php echo base_url(); ?>index.php/Laporan/save_adjustment_kas_cv");
        $('#formku').submit();
    };
};
