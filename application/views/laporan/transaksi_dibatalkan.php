...
<div class="row">                            
    <div class="col-md-12">       
        <?php
            if( ($group_id==1)||($hak_akses['transaksi_dibatalkan']==1) ){
        ?>
        <div class="row">
            <div class="col-md-12">
                <form accept-charset="utf-8" action="<?php echo base_url().'index.php/Laporan/transaksi_dibatalkan'; ?>" 
                ...
                <fieldset>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            ...
                            <a href="<?php echo base_url().'index.php/Laporan/transaksi_dibatalkan'; ?>" class="btn default">
                                <i class="fa fa-times"></i> Reset </a>
                        </div>
                        <div class="col-md-6" style="text-align:right">
                            <?php
                                if( ($group_id==1)||($hak_akses['print_transaksi_dibatalkan']==1) ){
                                    echo '<a href="'.base_url().'index.php/Laporan/print_transaksi_dibatalkan/'.$parameter.'" 
        ...
        <div class="portlet box blue-hoki">
            <div class="portlet-title">
                <div class="caption">
                    <i class="fa fa-file-o"></i>Laporan Transaksi Dibatalkan
                </div>
            </div>
            <div class="portlet-body">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><?php echo $data->alasan_cancel; ?></td>
                        <td style="text-align:right"><?php echo number_format($data->total_harga,0,',','.'); ?></td>                                                   
                    </tr>
                    <?php
                        }
                    ?>  
                    <tr><td colspan="6" style="text-align:right; font-weight:bold">
                            Total Transaksi (Rp) 
                        </td>
