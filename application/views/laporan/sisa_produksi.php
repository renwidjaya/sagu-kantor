...
<div class="row">                            
    <div class="col-md-12"> 
        <?php
            if( ($group_id==1)||($hak_akses['sisa_produksi']==1) ){
        ?> 
        <div class="row">
            <div class="col-md-12">
                <form accept-charset="utf-8" action="<?php echo base_url().'index.php/Laporan/sisa_produksi'; ?>" 
                ...
                <fieldset>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            ...
                            <a href="<?php echo base_url().'index.php/Laporan/sisa_produksi'; ?>" class="btn default">
                                <i class="fa fa-times"></i> Reset </a>
                        </div>
                        <div class="col-md-3" style="text-align:right">
                            <?php
                                if( ($group_id==1)||($hak_akses['print_sisa_produksi']==1) ){
                                    echo '<a href="'.base_url().'index.php/Laporan/print_sisa_produksi/'.((!empty($tgl_awal))? $tgl_awal: "NULL").'/'.$tgl_akhir.'" 
