...
<div class="row">                            
    <div class="col-md-12">       
        <?php
            if( ($group_id==1)||($hak_akses['tagihan_ekspedisi']==1) ){
        ?>
        <div class="row">
            <div class="col-md-12">
                <form accept-charset="utf-8" action="<?php echo base_url().'index.php/Laporan/tagihan_ekspedisi'; ?>" 
                ...
                <fieldset>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            ...
                            <a href="<?php echo base_url().'index.php/Laporan/tagihan_ekspedisi'; ?>" class="btn default">
                                <i class="fa fa-times"></i> Reset </a>
                        </div>
                        <div class="col-md-3" style="text-align:right">
                            <?php
                                if( ($group_id==1)||($hak_akses['print_tagihan_ekspedisi']==1) ){
                                    echo '<a href="'.base_url().'index.php/Laporan/print_tagihan_ekspedisi/'.((!empty($tgl_awal))? $tgl_awal: "NULL").'/'.$tgl_akhir.'" 
        ...
        <div class="portlet box blue-hoki">
            <div class="portlet-title">
                <div class="caption">
                    <i class="fa fa-file-o"></i>Laporan Tagihan Ekspedisi CV
                </div>
            </div>
            <div class="portlet-body">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style="text-align:center"><?php echo (($data->flag_bayar==1)? '<div style="background-color:green;color:white;padding:4px">Sudah dibayar</div>': '<div style="background-color:red;padding:4px">Belum dibayar</div>'); ?></td>
                    </tr>
                    <?php
                        }
                    ?>  
                    <tr><td colspan="7" style="text-align:right; font-weight:bold">
                            Total
                        </td>
                        <td style="text-align:right; background-color:#faf8b4">
                            <?php echo number_format($total['total_tagihan'],0,',','.'); ?>
                        </td>
                        <td>
                            &nbsp;
                        </td>
