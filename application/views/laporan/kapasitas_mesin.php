...
<div class="row">                            
    <div class="col-md-12">         
        ...
        <div class="row">
            <div class="col-md-12">
                <form accept-charset="utf-8" action="<?php echo base_url().'index.php/Laporan/kapasitas_mesin'; ?>" 
                ...
                <fieldset>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            ...
                            <a href="<?php echo base_url().'index.php/Laporan/kapasitas_mesin'; ?>" class="btn default">
                                <i class="fa fa-times"></i> Reset </a>
                        </div>
                        <div class="col-md-3" style="text-align:right">
                            <?php
                                if( ($group_id==1)||($hak_akses['print_kapasitas_mesin']==1) ){
                                    echo '<a href="'.base_url().'index.php/Laporan/print_kapasitas_mesin/'.((!empty($tgl_awal))? $tgl_awal: "NULL").'/'.$tgl_akhir.'" 
