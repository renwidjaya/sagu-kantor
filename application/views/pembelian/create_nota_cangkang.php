<div class="row">                            
    <div class="col-md-12">   
        <?php
            if( ($group_id==1)||($hak_akses['create_nota_cangkang']==1) ){
        ?>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="row">
                            <div class="col-md-12" style="text-align:right">
                                &nbsp;<br>
                                <a href="<?php echo base_url('index.php/Pembelian/print_nota_cangkang/'.$mydata['id']); ?>" 
                                   class="btn btn-primary" id="btnPrint" onclick="disableTombol();"><i class="fa fa-print"></i>&nbsp; Print Nota</a>
                                <a href="<?php echo base_url('index.php/Pembelian/index/CANGKANG'); ?>" class="btn btn-default">
                                    Kembali</a>
                            </div>
                        </div>
                    </div>
