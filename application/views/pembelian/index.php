        ...
        <div class="portlet box blue-hoki">
            ...
            <div class="portlet-body">
                ...
                <tbody>
                    <?php 
                        $no = 0;
                        $status = array(1=>'Masuk', 2=>'Timbang 1');
                        ...
                        <td style="text-align:center"> 
                            ...
                            <?php
                                    ...
                                    if( ($group_id==1)||($hak_akses['timbang_2']==1) ){                                        
                                        ...
                                        if($data->nama_muatan=="SINGKONG"){
                                            echo '<a class="btn btn-circle btn-xs green" style="margin-bottom:4px" '
                                            . 'href="'.base_url('index.php/Pembelian/singkong_timbang_kedua/'.$data->id).'"> &nbsp; '
                                            . '<i class="fa fa-edit"></i> Timbang 2&nbsp; </a>';

                                        }else if($data->nama_muatan=="CANGKANG" && $data->jenis_transaksi=="Beli"){
                                            echo '<a class="btn btn-circle btn-xs green" style="margin-bottom:4px" '
                                            . 'href="'.base_url('index.php/Pembelian/beli_cangkang_timbang_kedua/'.$data->id).'"> &nbsp; '
                                            . '<i class="fa fa-edit"></i> Timbang 2&nbsp; </a>'; 

                                        }else if($data->nama_muatan=="MERAH" && $data->jenis_transaksi=="Beli"){
                                            echo '<a class="btn btn-circle btn-xs green" style="margin-bottom:4px" '
                                            . 'href="'.base_url('index.php/Pembelian/beli_merah_timbang_kedua/'.$data->id).'"> &nbsp; '
                                            . '<i class="fa fa-edit"></i> Timbang 2&nbsp; </a>';                                        

                                        }else if($data->jenis_transaksi=="Jual"){
                                            echo '<a class="btn btn-circle btn-xs green" style="margin-bottom:4px" '
                                            ...
                                            echo '<a class="btn btn-circle btn-xs green" style="margin-bottom:4px" '
                                            . 'href="'.base_url('index.php/Pembelian/timbang_kedua/'.$data->id).'"> &nbsp; '
                                            . '<i class="fa fa-edit"></i> Timbang 2&nbsp; </a>';  
                                        }
                                    }
                                }
...
function timbang_pertama(id){
    $.ajax({
        url: "<?php echo base_url('index.php/Pembelian/get_data_otorisasi'); ?>",
        type: "POST",
        data : {id: id},
